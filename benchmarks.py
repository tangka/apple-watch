"""Data interpretation layer: benchmark levels, scoring, status lookup.

All human-readable text (labels, status names, notes) lives in i18n.py.
This module only contains numerical thresholds and the keys that index into
i18n. Label values here MUST match keys in i18n.STATIC for translation.
"""

# Each benchmark entry has:
#   label        — display name (EN; key into i18n.STATIC for translations)
#   unit         — unit string (EN; key into i18n.STATIC for translations)
#   accent       — UI color for the metric
#   lower_is_better — (optional) reverses status interpretation
#   levels       — [(lo, hi, status_label, color), ...]
#                  status_label is EN; key into i18n.STATIC for translations
#   source, url  — citation (not translated; scientific references)
BENCHMARKS = {
    "steps": {
        "label": "Daily Steps",  "unit": "steps/day",  "accent": "#22d3ee",
    ...
    "exercise_min_week": {
        "label": "Exercise Min / Week",  "unit": "min/wk",  "accent": "#22d3ee",
    ...
    "resting_hr_bpm": {
        "label": "Resting Heart Rate",  "unit": "bpm",  "accent": "#f472b6",
    ...
    "walking_hr_bpm": {
        "label": "Walking Heart Rate",  "unit": "bpm",  "accent": "#fb7185",
        "lower_is_better": True,
    ...
    "hrv_sdnn_ms": {
        "label": "HRV — SDNN",  "unit": "ms",  "accent": "#f472b6",
    ...
    "vo2_max": {
        "label": "VO₂ Max",  "unit": "mL/kg/min",  "accent": "#4ade80",
    ...
    "sleep_hours": {
        "label": "Sleep Duration",  "unit": "hrs/night",  "accent": "#a78bfa",
    ...
    "sleep_deep_h": {
        "label": "Deep Sleep (N3)",  "unit": "hrs",  "accent": "#818cf8",
    ...
    "sleep_rem_h": {
        "label": "REM Sleep",  "unit": "hrs",  "accent": "#c084fc",
    ...
    "spo2": {
        "label": "Blood Oxygen (SpO₂)",  "unit": "%",  "accent": "#38bdf8",
    ...
    "respiratory_rate": {
        "label": "Respiratory Rate",  "unit": "br/min",  "accent": "#38bdf8",
...
def apply_profile_benchmarks(age, sex):
    """Update age/sex-sensitive level tables in-place. No text content here —
    notes for these metrics are resolved via i18n.note_for_lang() at render
    time, which picks the dynamic template + interpolates age/sex."""
    a = age or 30
...
def score_grade(score):
    """Returns (letter, color, status_key). status_key is EN; translate via i18n."""
